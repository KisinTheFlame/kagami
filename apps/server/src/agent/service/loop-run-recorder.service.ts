...
import type { NapcatGroupMessageEvent } from "../event/event.js";
import type { LlmChatObservation } from "../../llm/client.js";
import { AppLogger } from "../../logger/logger.js";
import type { ToolSetExecutionResult } from "../tools/index.js";
import type { LoopRunDao } from "../dao/loop-run.dao.js";

const logger = new AppLogger({ source: "service.loop-run-recorder" });
