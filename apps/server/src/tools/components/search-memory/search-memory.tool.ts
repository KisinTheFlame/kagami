...
export class SearchMemoryTool extends ZodToolComponent<typeof SearchMemoryToolArgumentsSchema> {
  ...
  protected readonly inputSchema = SearchMemoryToolArgumentsSchema;
  private readonly memorySearchService: GroupMessageMemorySearchService;
  ...
  protected async executeTyped(
    input: z.infer<typeof SearchMemoryToolArgumentsSchema>,
    context: ToolContext,
  ): Promise<string> {
    ...
    return await this.memorySearchService.search({
      groupId,
      query,
    });
  }
