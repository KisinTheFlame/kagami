...
export class SpireStartRunTool extends SpireToolComponent<typeof Schema> {
  ...
  public readonly description =
    "开始一局新的尖塔爬塔（若已有对局会以新局覆盖）。可选 character 选角色：ironclad（铁甲战士，力量/格挡）或 silent（静默猎手，中毒/飞刀）；不填默认铁甲战士。返回开局战况。";
  public readonly parameters = {
    type: "object",
    properties: {
      character: {
        type: "string",
        enum: ["ironclad", "silent"],
        description: "角色：ironclad 铁甲战士 / silent 静默猎手。默认 ironclad。",
      },
    },
    required: [],
  } as const;
