...
| `@kagami/console`       | 管理台后端独立进程（Fastify），服务前端纯 DB 查询（app-log / llm-chat-call / inner-thought / napcat-event / napcat-group-message），经 @kagami/persistence 共享 DAO 直读 SQLite                                                                                                                                      |
...
| `@kagami/console-api`   | kagami-console 进程契约包：app-log / llm-chat-call（含 `:id` 路径参数）/ inner-thought / napcat-event / napcat-group-message 六条管理台查询路由（web 消费）                                                                                                                                                          |
...
| 观测查询        | `/app-log/query`、`/llm-chat-call/query`、`/llm-chat-call/:id`、`/inner-thought/query`、`/napcat-event/query`、`/napcat-group-message/query` |
