...
### 统一请求接口
```typescript
export interface OneTurnChatRequest {
...
## 相关文件
- `src/llm_providers/types.ts` - 核心类型定义
- `src/llm_providers/openai_provider.ts` - OpenAI 工具调用实现
- `src/llm_providers/genai_provider.ts` - Google GenAI 工具调用实现
